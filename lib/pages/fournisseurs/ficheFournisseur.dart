...
class FicheFournisseur extends StatefulWidget {
  static String id ="FicheFournisseur";
  @override
  _FicheClientState createState() => _FicheClientState();
}

class _FicheClientState extends State<FicheFournisseur> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: TextClasse(text: "Fiche Fournisseur", color: white, fontSize: 20, textAlign: TextAlign.center, family: "MonserratBold",),
